...
python3 ./npf-run.py local --test doc/example_namespaces.npf --graph-size 3 2.5 --graph-filename doc/example_namespaces.svg
python3 ./npf-run.py local --test doc/example_namespaces.npf --graph-size 3 2.5 --graph-filename doc/example_namespaces.svg --config 'var_sync={TIME}'